...
const SearchBox: React.FC<SearchBoxProps> = ({ isExpanded }) => {
  const ContainerComponent = isExpanded
    ? StyledInputContainerExpanded
    : StyledInputContainerReduced;

  const InputComponent = isExpanded ? InputExpanded : InputReduced;

  return (
    <ContainerComponent data-testid={isExpanded ? 'input-container-expanded' : 'input-container-reduced'}>
      <StyledInput>
        <InputComponent
          type="text"
          placeholder="Search anything"
          data-testid={isExpanded ? 'input-expanded' : 'input-reduced'}
        />
